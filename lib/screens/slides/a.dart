...
const stops = [3, 4, 5, 6, 7, 10, 11, 13, 16];
...
final slides = [
    ...
    propsBuilder: (context, controller, isActive, logger) {
      ...
      return [
        ...
        Positioned(
          left: 792,
          top: 522,
          child: Assets.images.props.slide01Whale.image(opacity: whaleOpacity),
        ),
        Positioned(
          left: 839,
          top: 471,
  ...
  Slide(
    audioPaths: {
      'en': Assets.audios.en.slide02,
      'pt': Assets.audios.pt.slide02,
    },
    propsBuilder: (context, controller, isActive, logger) {
      ...
      return [
                                          ...
                                          IntrinsicWidth(
                                            child: Column(
                                              crossAxisAlignment:
                                                  CrossAxisAlignment.stretch,
                                              children: [
                                                Assets.images.props.slide02Chart
                                                    .image(),
                                                const SizedBox(
                                                  height: 30,
                                                  child: Row(
        ...
        Positioned(
          ...
          top: 348,
          child:
              Assets.images.props.slide02Arrow.image(opacity: twoLeggedOpacity),
        ),
        Positioned(
          left: 365,
          top: 559,
                              ...
                              child: FadeTransition(
                                ...
                                child: SizedBox.shrink(
                                  child: OverflowBox(
                                    ...
                                    child: Column(
                                      children: [
                                        Assets.images.props.slide03Baby.image(),
                                        const Line(
    ...
    propsBuilder: (context, controller, isActive, logger) {
      ...
      return [
        ...
        Positioned(
          left: 1526,
          top: 490,
          child: Assets.images.props.slide05Curve.image(opacity: circleOpacity),
        ),
        Positioned(
          left: 1521,
          top: 535.5,
    ...
    propsBuilder: (context, controller, isActive, logger) {
      ...
      return [
        ...
        Positioned(
          left: 1410,
          top: 510.5,
          child: Assets.images.props.slide09Arrow.image(opacity: arrowOpacity),
        ),
        Positioned(
          left: 1226,
          top: 607,
