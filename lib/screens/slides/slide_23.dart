...
class Slide23 extends ConsumerWidget {
  const Slide23({
    super.key,
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return Slide(
      ...
      audioPath: locale.languageCode == 'en'
          ? Assets.audios.en.slide23
          : Assets.audios.pt.slide23,
      ...
      propsBuilder: (context, controller) {
        ...
        return [
          Positioned(
            ...
            top: -3,
            child:
                Assets.images.props.slide23Cargo.image(opacity: boatsOpacity),
          ),
          Positioned(
            left: 306,
            top: 224.5,
            child: FadeTransition(
              ...
              child: Assets.images.props.slide23CargoNoise
          ...
          Positioned(
            left: 1253.5,
            top: 22,
            child: Assets.images.props.slide23Oil.image(opacity: boatsOpacity),
          ),
          Positioned(
            left: 1331,
            top: 221,
            child: Assets.images.props.slide23OilNoise
                .image(opacity: noiseOpacity),
          ),
          Positioned(
            left: 1392.5,
            top: 676.5,
            child: Assets.images.props.slide23BottomNoise
                .image(opacity: noiseOpacity),
          ),
          Positioned(
            left: 437,
            top: 347,
            child:
                Assets.images.props.slide23Whale.image(opacity: whaleOpacity),
          ),
          Positioned(
            left: 818,
            top: 388,
            child: Assets.images.props.slide23WhaleEffects
