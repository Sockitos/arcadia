...
const setupMessagesPT = <OpenAIChatCompletionChoiceMessageModel>[
  OpenAIChatCompletionChoiceMessageModel(
    content:
        'You are a helpful assistant that uses storytelling as a way to give elaborate and creative answers.',
    role: OpenAIChatMessageRole.system,
...
final messagesProvider =
  ...
  (ref) {
    ...
    return locale.languageCode == 'pt' ? setupMessagesPT : setupMessagesEN;
  },
);
